...
# Definition
#
filename = './subject_data/medium/sbj%d_node5.mat'
...
def draw_trial_sem(num_nodes, trial_buf, efficiency, plt_metric):
	...
	print ('effect size (Hedges g) between oneshot+ and oneshot- = %f' % hedges_g)
